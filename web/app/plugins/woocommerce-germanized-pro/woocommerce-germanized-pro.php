...
if ( ! class_exists( 'WooCommerce_Germanized_Pro' ) ) :
	...
	final class WooCommerce_Germanized_Pro {
		...
		public function load_modules() {
			...
			if ( apply_filters( 'woocommerce_gzdp_enable_food_module', true ) ) {
		...
		public function support_german_language_variants( $locale, $domain ) {
			if ( 'woocommerce-germanized-pro' === $domain && apply_filters( 'woocommerce_gzdp_force_de_language', in_array( $locale, array( 'de_CH', 'de_AT' ), true ) ) ) {
				$locale = 'de_DE';
			}
