...
use Vendidero\StoreaBill\Vendor\Mpdf\Mpdf as MpdfObject;
...
class Mpdf
{
	 ...
	 *
	 * @param \Vendidero\StoreaBill\Vendor\Mpdf\QrCode\QrCode $qrCode QR code instance
	 * @param \Vendidero\StoreaBill\Vendor\Mpdf\Mpdf $mpdf Mpdf instance
