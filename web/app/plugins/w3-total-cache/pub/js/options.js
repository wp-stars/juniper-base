...
function w3tc_cdn_get_cnames()
{
    ...
    jQuery('#cdn_cnames input[type=text]').each(
        function () {
...
function w3tc_toggle2(name, dependent_ids)
{
    ...
    jQuery(dependants).on(
        'click', function () {
            var total_checked = true;

            jQuery(dependants).each(
                function () {
...
function w3tc_security_headers()
{
    ...
    jQuery('#browsercache_security_hsts_directive,#browsercache_security_xfo_directive,#browsercache_security_xss_directive,#browsercache_security_pkp_extra,#browsercache_security_pkp_report_only').on(
        'change',
        function () {
...
function w3tc_csp_reference()
{
    ...
    jQuery('div#overlay,.lightbox-content').on(
        'click', function () {
            W3tc_Lightbox.close();
        }
    );
...
jQuery(
    function () {
        // general page
        jQuery('.w3tc_read_technical_info').on(
            'click', function () {
                jQuery('.w3tc_technical_info').toggle();
            }
        );

        jQuery('#plugin_license_key_verify').on(
            'click', function () {
        ...
        jQuery('#pgcache__reject__logged_roles').on(
            'click', function () {
                w3tc_input_enable('#pgcache_reject_roles input[type=checkbox]', jQuery('#pgcache__reject__logged_roles:checked').length);
            }
        );
        ...
        jQuery('#pgcache__cache__feed').on(
            'change', function () {
                if(jQuery('#pgcache__cache__nginx_handle_xml').is('*')) {
        ...
        jQuery('#css_themes').on(
            'change', function () {
                w3tc_minify_css_theme(jQuery(this).val());
            }
        );

        jQuery('#minify_form').on(
            'submit', function () {
        ...
        jQuery('#cdn_test').on(
            'click', function () {
             ...
             break;
                ...
                jQuery.post(
                    'admin.php?page=w3tc_dashboard', params, function (data) {
        ...
        jQuery('#cdn_create_container').on(
            'click', function () {
                var me = jQuery(this);
                var metadata = me.metadata();
                var cnames = w3tc_cdn_get_cnames();
        ...
        jQuery('.w3tc_common_redis_test').on(
            'click', function () {
            ...
            jQuery('#mobile_groups').sortable(
                {
                    axis: 'y',
                    stop: function () {
                        jQuery('#mobile_groups').find('.mobile_group_number').each(
                            function (index) {
            ...
            jQuery('#referrer_groups').sortable(
                {
                    axis: 'y',
                    stop: function () {
                        jQuery('#referrer_groups').find('.referrer_group_number').each(
                            function (index) {
                                jQuery(this).html((index + 1) + '.');
                            }
                        );
        ...
        jQuery('.w3tc-show-required-changes').on(
            'click', function () {
        ...
        // show hide missing files
        jQuery('.w3tc-show-technical-info').on(
            'click', function () {
        ...
        jQuery('#ftp_upload_form').find('input').each(
            function () {
        ...
        jQuery('#w3tc input,#w3tc select,#w3tc textarea').on(
            'change', function () {
                var ignore = false;
                jQuery(this).parents().addBack().each(
                    function () {
        ...
        jQuery('.contextual-help-tabs ul li a').on(
            'click', function () {
        ...
        jQuery('#contextual-help-link').on(
            'click', function () {
        ...
        // extensions page
        jQuery('.w3tc_extensions_manage_input_checkall').on(
            'click', function (v) {
                var c = jQuery(this).is(':checked');

                jQuery('.w3tc_extensions_manage_input_checkall').prop('checked', c);
                jQuery('.w3tc_extensions_input_active').each(
                    function (index) {
