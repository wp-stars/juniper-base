...
const FilterNew = data => {
  ...
  function applyFilter(filter) {
    ...
    for (const filterOption of filterOptions) {
      ...
      switch (filterOptionName) {
        case 'searchText':
          toFilterData = toFilterData.filter(post => (0,_utils__WEBPACK_IMPORTED_MODULE_1__.postInTextSelection)(filterValue[1].toLowerCase().trim(), post));
          break;
  ...
  function setUpFilters() {
    ...
    const preparedOptions = filterOptions.map(filterOption => {
      ...
      filterOption.chooseTag = _TranslationObject__WEBPACK_IMPORTED_MODULE_5__["default"].choose;
      filterOption.label = _TranslationObject__WEBPACK_IMPORTED_MODULE_5__["default"][filterOption.name] ? _TranslationObject__WEBPACK_IMPORTED_MODULE_5__["default"][filterOption.name] : filterOption.label;
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    name: 'Product Search',
    url: 'text',
    placeholder: _TranslationObject__WEBPACK_IMPORTED_MODULE_5__["default"].product_search,
