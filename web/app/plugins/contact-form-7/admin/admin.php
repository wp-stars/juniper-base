...
function wpcf7_load_contact_form_admin()
{
    ...
    if ($post
        ...
        if (! class_exists('WPCF7_Contact_Form_List_Table') ) {
            include_once WPCF7_PLUGIN_DIR . '/admin/includes/class-contact-forms-list-table.php';
        }
...
function wpcf7_admin_management_page()
{
    if ($post = wpcf7_get_current_contact_form() ) {
        ...
        include_once WPCF7_PLUGIN_DIR . '/admin/includes/editor.php';
        include_once WPCF7_PLUGIN_DIR . '/admin/edit-contact-form.php';
        return;
    }
