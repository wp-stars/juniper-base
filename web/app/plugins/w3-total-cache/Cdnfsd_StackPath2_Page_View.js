jQuery(
    function ($) {
        ...
        $('body')
        .on(
            'click', '.w3tc_cdn_stackpath2_fsd_authorize', function () {
                W3tc_Lightbox.open(
                    {
                        id:'w3tc-overlay',
                        close: '',
        ...
        .on(
            'click', '.w3tc_cdn_stackpath2_fsd_list_stacks', function () {
        ...
        .on(
            'click', '.w3tc_cdn_stackpath2_fsd_list_sites', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_stackpath2_fsd_view_site', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_stackpath2_fsd_configure_site', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_stackpath2_fsd_configure_site_skip', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_stackpath2_fsd_done', function () {
                // refresh page
