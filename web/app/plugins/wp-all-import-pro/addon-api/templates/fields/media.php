...
<input type="text" placeholder="" value="<?php echo (!is_array($field_value)) ? esc_attr($field_value) : esc_attr($field_value['url']); ?>" name="<?php echo esc_attr($html_name); ?>[url]" class="text w95 widefat rad4" />
...
<div class="pmxi-addon-subfields">
    ...
    <div class="input">
        ...
        <label for="<?php echo $html_id . '_search_in_files'; ?>">
            <?php _e('Use images currently uploaded in wp-content/uploads/wpallimport/files/', 'wp_all_import_plugin'); ?>
        </label>
    </div>
</div>
