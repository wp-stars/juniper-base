	...
	if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
		error_log(  // phpcs:ignore
			...
			/* translators: 1: composer command. 2: plugin directory */
				esc_html_x( 'Your installation of the vendidero helper plugin is incomplete. Please run %1$s within the %2$s directory.', 'vd-helper', 'woocommerce-germanized-pro' ),
				'`composer install`',
