       ...
       'bootup-time'                  => array(
        ...
        'mainthread-work-breakdown'    => array(
                    'instructions' =>
						...
						<p>' . esc_html__('Delay 3rd-party JS', 'w3-total-cache') .                             <p>' . esc_html__('Reducing JavaScript execution time', 'w3-total-cache') . '</p>
        <p>' . sprintf(
                            ...
                            '</a>                 ) .                             <p>' . esc_html__('Reducing CSS parsing time', 'w3-total-cache') . '</p>
        <p>' . sprintf(
        ...
        'no-document-write'            => array(
                    'instructions' =>
                        '<p>' . esc_html__('You can fix this audit by preferably eliminating document.write() altogether, wherever possible.', 'w3-total-cache') .                             <p>' . esc_html__('Avoiding the use of document.write() should ideally be built into your development workflow so that your production website is optimized for web performance from the beginning.', 'w3-total-cache') . '</p>
        <p>' . sprintf(
                            // translators: 1 W3TC plugin name.
                            esc_html__(
       ...
       'unsized-images'               => array(
        ...
        'long-tasks'                       => array(
                    'instructions' =>
						...
						<p>' . esc_html__('Debouncing your input handlers helps solve both of the above problems.', 'w3-total-cache') . '</p>
						<br/>
						<p>' . esc_html__('Delay 3rd-party JS', 'w3-total-cache') .                                         <li>' . esc_html__('Reducing JavaScript execution time', 'w3-total-cache') . '</li>
        <li>' . sprintf(
