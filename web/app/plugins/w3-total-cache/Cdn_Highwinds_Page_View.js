jQuery(
    function ($) {
        ...
        $('body')
        .on(
            'click', '.w3tc_cdn_highwinds_authorize', function () {
                W3tc_Lightbox.open(
                    {
                        id:'w3tc-overlay',
                        close: '',
        ...
        .on(
            'click', '.w3tc_cdn_highwinds_select_host', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
                '&w3tc_action=cdn_highwinds_select_host';

                var v = $('.w3tc_cdn_highwinds_form').find('input').each(
                    function (i) {
        ...
        .on(
            'click', '.w3tc_cdn_highwinds_configure_host', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_highwinds_configure_cnames_form', function () {
                W3tc_Lightbox.open(
                    {
                        id:'w3tc-overlay',
                        close: '',
        ...
        .on(
            'click', '.w3tc_cdn_highwinds_configure_cnames', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
