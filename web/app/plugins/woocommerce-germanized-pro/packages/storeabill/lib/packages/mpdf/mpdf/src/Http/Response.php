 ...
 */
class Response implements \Vendidero\StoreaBill\Vendor\Psr\Http\Message\ResponseInterface
{
	...
	/** @var \Vendidero\StoreaBill\Vendor\Psr\Http\Message\StreamInterface */
	private $stream;
