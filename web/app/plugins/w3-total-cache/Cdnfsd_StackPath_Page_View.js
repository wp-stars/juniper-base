jQuery(
    function ($) {
        ...
        $('body')
        .on(
            'click', '.w3tc_cdn_stackpath_fsd_authorize', function () {
                W3tc_Lightbox.open(
                    {
                        id:'w3tc-overlay',
                        close: '',
        ...
        .on(
            'click', '.w3tc_cdn_stackpath_fsd_list_zones', function () {
        ...
        .on(
            'click', '.w3tc_cdn_stackpath_fsd_view_zone', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_stackpath_fsd_configure_zone', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_stackpath_fsd_configure_zone_skip', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_stackpath_fsd_done', function () {
                // refresh page
