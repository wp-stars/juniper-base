...
if (!class_exists('S3Compatible') ) {
    include_once W3TC_LIB_DIR . '/S3Compatible.php';
}
...
class CdnEngine_S3_Compatible extends CdnEngine_Base
{
    ...
    function __construct( $config = array() )
    {
        ...
        $this->_s3 = new \S3Compatible(
            $config['key'], $config['secret'], false,
            $config['api_host'] 
        );
    ...
    function _upload_gzip( $file, $force_rewrite = false )
    {
        ...
        return $this->_get_result(
            $local_path, $remote_path,
            W3TC_CDN_RESULT_ERROR, sprintf(
                'Unable to put object (%s).',
