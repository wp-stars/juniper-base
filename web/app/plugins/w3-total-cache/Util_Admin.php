...
class Util_Admin
{
    ...
    */
    ...
    static public function config_save( $current_config, $new_config )
    {
         ...
         */
        if ($old_config->get_string('pgcache.engine') !=      $new_config->get_string('pgcache.engine') 
            || $old_config->get_string('pgcache.enabled') !=      $new_config->get_string('pgcache.enabled') 
        ) {
