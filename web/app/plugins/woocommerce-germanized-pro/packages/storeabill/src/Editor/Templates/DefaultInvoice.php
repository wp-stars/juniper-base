...
class DefaultInvoice extends Template {
	...
	public static function get_html() {
		...
		<p class="has-text-align-left"><?php echo apply_filters( self::get_hook_prefix() . 'reverse_charge_notice', esc_html_x( 'Tax free intracommunity despatch/delivery.', 'storeabill-core', 'woocommerce-germanized-pro' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
		<!-- /wp:storeabill/reverse-charge-notice -->
