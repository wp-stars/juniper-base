...
const FilterNew = data => {
  var _data$title, _data$postType, _translation;
    ...
    for (const filterOption of filterOptions) {
      ...
      switch (filterOptionName) {
        ...
        case 'sampleAvailable':
          toFilterData = toFilterData.filter(_utils__WEBPACK_IMPORTED_MODULE_2__.postHasSampleAvailable);
          break;
        case 'onlineAvailable':
          toFilterData = toFilterData.filter(_utils__WEBPACK_IMPORTED_MODULE_2__.postIsAvailableOnline);
          break;
        default:
          if ((0,_utils__WEBPACK_IMPORTED_MODULE_2__.isArray)(filterValue)) {
            toFilterData = toFilterData.filter(post => filterValue.some(singleValue => (0,_utils__WEBPACK_IMPORTED_MODULE_2__.postInSelection)(filterOptionName, singleValue.value, post)));
          } else {
            toFilterData = toFilterData.filter(post => (0,_utils__WEBPACK_IMPORTED_MODULE_2__.postInSelection)(filterOptionName, filterValue.value, post));
          }
      }
    }
  ...
  }, show_sample_available_filter && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_SingleFilterComponents_FilterCheckbox__WEBPACK_IMPORTED_MODULE_5__["default"], {
    key: 'sampleAvailable',
  ...
  }), show_online_available_filter && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_SingleFilterComponents_FilterCheckbox__WEBPACK_IMPORTED_MODULE_5__["default"], {
    key: 'onlineAvailable',
  ...
  }, translationObject.results_label, ": ", filteredPosts.length))) : null), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, isCurrentlyLoading ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: 'loading-spinner'
  }) : morePostsToDisplay() && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    onClick: showMore,
...
const FilterDropdown = data => {
  var _data$url, _data$multiSelect, _data$tax_options;
  data = data.data ? data.data : data;
  const key = data.key;
  const label = data.label;
  const name = data.name;
  ...
  const Option = props => {
    ...
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_select__WEBPACK_IMPORTED_MODULE_4__.c.Option, {
      ...props
    }));
  };
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, label), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_select__WEBPACK_IMPORTED_MODULE_5__["default"], {
...
/***/ "./src/newComponents/SingleFilterComponents/MobileFilter.js":
/*!******************************************************************!*\
  !*** ./src/newComponents/SingleFilterComponents/MobileFilter.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MobileFilter);
