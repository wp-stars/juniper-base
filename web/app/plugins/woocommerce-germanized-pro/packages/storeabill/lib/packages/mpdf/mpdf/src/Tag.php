...
class Tag
{
	...
	/**
	 * @param \Vendidero\StoreaBill\Vendor\Mpdf\Mpdf $mpdf
	 * @param \Vendidero\StoreaBill\Vendor\Mpdf\Cache $cache
	 * @param \Vendidero\StoreaBill\Vendor\Mpdf\CssManager $cssManager
	 * @param \Vendidero\StoreaBill\Vendor\Mpdf\Form $form
	 * @param \Vendidero\StoreaBill\Vendor\Mpdf\Otl $otl
	 * @param \Vendidero\StoreaBill\Vendor\Mpdf\TableOfContents $tableOfContents
	 * @param \Vendidero\StoreaBill\Vendor\Mpdf\SizeConverter $sizeConverter
	 * @param \Vendidero\StoreaBill\Vendor\Mpdf\Color\ColorConverter $colorConverter
	 * @param \Vendidero\StoreaBill\Vendor\Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \Vendidero\StoreaBill\Vendor\Mpdf\Language\LanguageToFontInterface $languageToFont
	 */
	 ...
	 * @return \Vendidero\StoreaBill\Vendor\Mpdf\Tag\Tag
	 */
	...
	public static function getTagClassName($tag)
	{
		...
		$className = 'Vendidero\StoreaBill\Vendor\Mpdf\Tag\\';
