...
class Cdn_Environment
{
    ...
    public function fix_on_event( $config, $event, $old_config = null )
    {
        if ($config->get_boolean('cdn.enabled') 
            ...
            if ($old_config != null 
                && $config->get_integer('cdn.queue.interval') !=       $old_config->get_integer('cdn.queue.interval') 
            ) {
        ...
        if ($config->get_boolean('cdn.enabled') 
            ...
            if ($old_config != null 
                && $config->get_integer('cdn.autoupload.interval') !=       $old_config->get_integer('cdn.autoupload.interval') 
            ) {
    ...
    */
    ...
    {
        Util_Rule::add_rules(
            $exs, Util_Rule::get_browsercache_rules_cache_path(),
