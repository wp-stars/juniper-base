...
class Generic_Plugin_AdminNotifications
{
    ...
    function run()
    {
        if (Util_Admin::is_w3tc_admin_page() ) {
            ...
            add_action(
                'w3tc_message_action_generic_support_us', array(
                $this,
                'w3tc_message_action_generic_support_us'
                ) 
            );
            add_action(
                'w3tc_ajax_generic_support_us', array(
                $this,
            ...
            add_action(
                'w3tc_message_action_generic_edge', array(
                $this,
    ...
    function admin_head()
    {
        ...
        if ($support_reminder ) {
            ...
            $state->set(
                'common.next_support_us_invitation',
                time() + $delay 
            );
