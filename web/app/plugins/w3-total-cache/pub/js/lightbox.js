var W3tc_Lightbox = {
    ...
    create: function () {
        ...
        this.container.find('.lightbox-close').on(
            'click', function () {
                me.close();
            }
        );
    ...
    W3tc_Lightbox.open(
        {
            ...
            callback: function (lightbox) {
                ...
                jQuery('.recom_apply', lightbox.container).on(
                    'click', function () {
                        var theme = jQuery('#recom_theme').val();

                        jQuery('#js_files li').each(
                            function () {
                        ...
                        jQuery('#recom_css_files li').each(
                            function () {
                                if (jQuery(this).find(':checkbox:checked').length) {
    ...
    W3tc_Lightbox.open(
        {
            ...
            callback: function (lightbox) {
                jQuery('.button-primary', lightbox.container).on(
                    'click', function () {
                        lightbox.close();
                    }
                );
    ...
    W3tc_Lightbox.open(
        {
            ...
            callback: function (lightbox) {
                ...
                jQuery('#w3tc-purchase', lightbox.container).on(
                    'click', function () {
                        lightbox.close();
    ...
    W3tc_Lightbox.open(
        {
            ...
            callback: function (lightbox) {
                var w3tc_license_listener = function (event) {
                    ...
                    if (data[0] === 'license') {
                        // legacy purchase
                        w3tc_lightbox_save_licence_key(
                            function () {
                                lightbox.close();
                            }
                        );
...
jQuery(
    function () {
        jQuery('.button-minify-recommendations').on(
            'click', function () {
        ...
        jQuery('body').on(
            'click', '.w3tc_lightbox_close', function () {
                W3tc_Lightbox.close();
            }
        );
    }
