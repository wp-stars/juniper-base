<?php
/**
 * The Template for displaying all single invoices
 *
...
?>
	...
	<!-- sab:header -->
	<?php sab_get_template( 'invoice/header.php' ); ?>
	<!-- /sab:header -->

	<!-- sab:header_first_page -->
	<?php sab_get_template( 'invoice/header-first-page.php' ); ?>
	<!-- /sab:header_first_page -->
	 ...
	 */
	do_action( 'storeabill_before_invoice_content', $invoice->get_id() );
	?>

	<?php sab_get_template( 'invoice/content.php' ); ?>
	 ...
	 */
	do_action( 'storeabill_after_invoice_content', $invoice->get_id() );
	?>
	<!-- /sab:content -->

	<!-- sab:footer -->
	<?php sab_get_template( 'invoice/footer.php' ); ?>
	<!-- /sab:footer -->

	<!-- sab:footer_first_page -->
	<?php sab_get_template( 'invoice/footer-first-page.php' ); ?>
	<!-- /sab:footer_first_page -->
