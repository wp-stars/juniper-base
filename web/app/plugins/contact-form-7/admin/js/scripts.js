( function ( $ ) {
    ...
    $(
        function () {
            ...
            $('a.welcome-panel-close', welcomePanel).click(
                function ( event ) {
            ...
            $('#wpcf7-welcome-panel-show').click(
                function ( event ) {
                    if (this.checked ) {
            ...
            $('input:checkbox.toggle-form-table').click(
                function ( event ) {
            ...
            $(window).on(
                'beforeunload', function ( event ) {
                    ...
                    $('#wpcf7-admin-form-element :input[type!="hidden"]').each(
                        function () {
            ...
            $('#wpcf7-ctct-enable-contact-list, #wpcf7-sendinblue-enable-contact-list, #wpcf7-sendinblue-enable-transactional-email').on(
                'change', function () {
                    if ($(this).is(':checked') ) {
    ...
    wpcf7.updateConfigErrors = function () {
        ...
        $('#contact-form-editor-tabs > li').each(
            function () {
                var $item = $(this);
