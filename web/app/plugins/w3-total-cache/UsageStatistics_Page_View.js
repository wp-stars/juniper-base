jQuery(document).ready(
    function ($) {
        ...
        function load()
        {
            ...
            $.getJSON(
                ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        function setChartsAccessLog(data)
        {
            if (!charts['accessLogRequests']) {
                ...
                charts['accessLogRequests'] = new Chart(
                    ctx, {
                        type: 'bar',
                        data: {
                            labels: chartDateLabels,
            ...
            if (!charts['accessLogTiming']) {
                ...
                charts['accessLogTiming'] = new Chart(
                    ctx, {
                        type: 'bar',
                        data: {
                            labels: chartDateLabels
        ...
        function setChartsMemcached(data)
        {
            if (!charts['memcachedSize']) {
                ...
                charts['memcachedSize'] = new Chart(
                    ctx, {
                        type: 'bar',
                        data: {
                            labels: chartDateLabels
        ...
        {
            jQuery('.metabox-holder').each(
                function () {
                    var visible = false;
                    jQuery(this).find('.ustats_block').each(
                        function () {
