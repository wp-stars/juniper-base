...
class Collection extends Sortable
{
    ...
    {
        return new \MatthiasWeb\RealMediaLibrary\lite\folder\Collection($rowData->id, $rowData->parent, $rowData->name, $rowData->slug, $rowData->absolute, $rowData->ord, $rowData->cnt_result, $rowData);
    }
    ...
    {
        return parent::getTypeDescription($default === null ? \__('A collection cannot contain files. But you can create other collections and <strong> galleries</strong> there.', RML_TD) : $default);
    }
    // Documented in IFolder
