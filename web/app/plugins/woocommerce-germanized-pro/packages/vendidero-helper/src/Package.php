		...
		if ( $product = self::get_product_by_id( $product_id ) ) {
			return new \WP_Error(
				...
				// translators: %s: Renewal url.
					_x( 'Your update- and support-flat has expired. Please <a href="%s" target="_blank">renew</a> your license before updating.', 'vd-helper', 'woocommerce-germanized-pro' ),
			...
			return new \WP_Error(
				'vendidero_expired',
				_x( 'Your update- and support-flat has expired. Please renew your license before updating.', 'vd-helper', 'woocommerce-germanized-pro' )
			);
		}
	}
