...
class Cdn_Plugin_Admin
{
    function run()
    {
        ...
        if ($cdn_engine == 'google_drive' ) {
            add_action(
                'w3tc_settings_cdn_boxarea_configuration', array(
            ...
            add_action(
                'w3tc_ajax_cdn_highwinds_widgetdata', array(
                '\W3TC\Cdn_Highwinds_Widget',
            ...
            add_action(
                'w3tc_ajax_cdn_stackpath_widgetdata', array(
                '\W3TC\Cdn_StackPath_Widget',
            ...
            add_action(
                'w3tc_ajax_cdn_stackpath2_widgetdata', array(
                '\W3TC\Cdn_StackPath2_Widget',
        ...
        add_action(
            'w3tc_settings_general_boxarea_cdn', array(
            $this,
