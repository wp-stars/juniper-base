...
jQuery(
    function () {
        ...
        jQuery('#mobile_form').on(
            'submit', function () {
                var error = false;

                jQuery('#mobile_groups li').each(
                    function () {
                                ...
                                function () {
                                    if (jQuery(this).find(':checked').length) {
                                        ...
                                        if (compare_group != group) {
                                            ...
                                            jQuery.each(
                                                compare_agents, function (index, value) {
                ...
                if (group !== null) {
                    ...
                    if (group) {
                        ...
                        if (!exists) {
                                ...
                                jQuery.each(
                                    mobile_themes, function (index, value) {
        ...
        jQuery('#referrer_form').on(
            'submit', function () {
                var error = false;

                jQuery('#referrer_groups li').each(
                    function () {
                        if (jQuery(this).find(':checked').length) {
                ...
                if (group !== null) {
                    ...
                    if (group) {
                        ...
                        if (!exists) {
                                ...
                                jQuery.each(
                                    referrer_themes, function (index, value) {
                                        select.append(jQuery('<option />').val(index).html(value));
                                    }
                                );
        ...
        jQuery('#w3tc_cookiegroup_add').on(
            'click', function () {
                var group = prompt('Enter group name (only "0-9", "a-z", "_" symbols are allowed).');
        ...
        jQuery('.w3tc_cookiegroup_delete').on(
            'click', function () {
                if (confirm('Are you sure want to delete this group?')) {
