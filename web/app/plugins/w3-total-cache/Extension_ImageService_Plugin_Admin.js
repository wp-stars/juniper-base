        ...
        .done(
            function ( response ) {
                if (response.data && response.data.hasOwnProperty('total') ) {
                    [ 'total', 'converted', 'sending', 'processing', 'notconverted', 'unconverted' ].forEach(
                        function ( className ) {
                            var size,
                             $size,
        ...
        .done(
            function ( response ) {
                if (response.data && response.data.hasOwnProperty('usage_hourly') ) {
                    [ 'usage_hourly', 'usage_monthly', 'limit_hourly', 'limit_monthly' ].forEach(
                        function ( keyName ) {
    ...
    function convertItem()
    {
        ...
        .fail(
            function ( response ) {
                ...
                if (response && response.hasOwnProperty('responseJSON') 
