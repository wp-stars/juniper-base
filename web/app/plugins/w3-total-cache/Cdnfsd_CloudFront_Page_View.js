jQuery(
    function ($) {
        ...
        $('body')
        .on(
            'click', '.w3tc_cdn_cloudfront_fsd_authorize', function () {
                W3tc_Lightbox.open(
                    {
                        id:'w3tc-overlay',
                        close: '',
        ...
        .on(
            'click', '.w3tc_cdn_cloudfront_fsd_view_distribution', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_cloudfront_fsd_configure_distribution', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_cloudfront_fsd_configure_distribution_skip', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_cloudfront_fsd_done', function () {
                // refresh page
