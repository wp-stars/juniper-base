( function ( $ ) {
    ...
    $('form.tag-generator-panel .control-box :input').change(
        function () {
    ...
    wpcf7.taggen.compose = function ( tagType, $form ) {
        ...
        scope.find('input.option').not(':checkbox,:radio').each(
            function ( i ) {
                var val = $(this).val();
        ...
        scope.find('input:checkbox.option').each(
            function ( i ) {
                if ($(this).is(':checked') ) {
        ...
        scope.find('input:radio.option').each(
            function ( i ) {
