...
var W3tc_Popup_Cdn_Export_File = {
    ...
    init: function () {
        var me = this;
        jQuery('#cdn_export_file_start').click(
            function () {
                if (this.value == 'Pause') {
                    me.paused = 1;
...
var W3tc_Popup_Cdn_Export_Library = {
    ...
    init: function () {
        var me = this;
        jQuery('#cdn_export_library_start').click(
            function () {
                if (this.value == 'Pause') {
                    me.paused = 1;
                    me.set_status('paused');
...
var W3tc_Popup_Cdn_Import_Library = {
    ...
    init: function () {
        var me = this;
        jQuery('#cdn_import_library_start').click(
            function () {
                if (this.value == 'Pause') {
                    me.paused = 1;
                    me.set_button_text('Resume');
...
var W3tc_Popup_Cdn_Rename_Domain = {
    ...
    init: function (cdn_host) {
        ...
        jQuery('#cdn_rename_domain_start').click(
            function () {
                if (this.value == 'Pause') {
                    me.paused = 1;
                    me.set_button_text('Resume');
...
jQuery(
    function () {
        ...
        jQuery('.ps-rule p a,.ps-expander').click(
            function (event) {
                event.stopPropagation();
            }
        );

        jQuery('.ps-expand-all').click(
            function () {
                w3tc_ps_expand(1);
            }
        );

        jQuery('.ps-collapse-all').click(
            function () {
                w3tc_ps_expand(0);
            }
        );
