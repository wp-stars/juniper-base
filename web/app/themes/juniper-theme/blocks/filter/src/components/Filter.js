    ...
    return (
        <div className="w-full">
                ...
                {isMobile ?
                    <div className="w-full flex justify-end items-center mt-3 sm:mt-[-55px]">
                        ...
                        >
                            ...
                            <svg className="w-[2.5rem] h-[2.5rem] open-toggle" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <svg className="w-[2.5rem] h-[2.5rem] close-toggle" xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 35 35" fill="none">
                                <path d="M26.25 8.75L8.75 26.25" stroke="#000" strokeWidth="2" strokeLinecap="round"
                                      strokeLinejoin="round"/>
                                <path d="M8.75 8.75L26.25 26.25" stroke="#000" strokeWidth="2" strokeLinecap="round"
                                      strokeLinejoin="round"/>
                            </svg>
                        </button>
                    </div>
                                        ...
                                        return (
                                            <div key={key}
                                                ...
                                                >
                                                    ...
                                                    {filterItem.tax_options.map((term) => (
                    ...
                    {displayedPosts.length ? (
                        displayedPosts.map((post, index) => (
                            <div key={index}
                                 ...
                                 dangerouslySetInnerHTML={{__html: atob(post.html)}}></div>
                        ))
                    ) : (
            ...
            <div className="container flex justify-center items-center my-24 flex-col gap-y-6">
                ...
                <p className="text-base leading-normal italic">{calculateDisplayedRange()}</p>
            </div>
