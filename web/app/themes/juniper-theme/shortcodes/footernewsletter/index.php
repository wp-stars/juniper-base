...
if ( ! class_exists( 'FooterNewsletter' ) ) {
	...
	class FooterNewsletter {
		...
		public function enqueue_hubspot_script_in_footer(): void {
//			wp_enqueue_script( 'hubspot-forms-script', get_template_directory_uri() . '/shortcodes/footernewsletter/external/hsforms.min.v2.js', [], '1.0', true );
		}
