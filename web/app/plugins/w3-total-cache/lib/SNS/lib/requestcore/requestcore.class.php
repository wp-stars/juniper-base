...
class RequestCore
{
     ...
     *                        <li><code>callback</code> - <code>string|array</code> - Optional - The string name
     *                        of a function to pass the response data to. If this is a method, pass an array where
     *                        the <code>[0]</code> index is the class and the <code>[1]</code> index is the method
     *                        name.</li> <li><code>limit</code> - <code>integer</code> - Optional - The number of
     *                        simultaneous requests to make. This can be useful for scaling around slow server
