...
class AmazonSNS extends CFRuntime
{
     ...
     *                           <li><code>AuthenticateOnUnsubscribe</code> - <code>string</code> - Optional -
     *                           Indicates that you want to disable unauthenticated unsubsciption of the
     *                           subscription. If parameter is present in the request, the request has an AWS
     *                           signature, and the value of this parameter is true, only the topic owner and the
     *                           subscription owner will be permitted to unsubscribe the endopint, and the
     *                           Unsubscribe action will require AWS authentication. </li> <li><code>curlopts</code>
     *                           - <code>array</code> - Optional - A set of values to pass directly into
     *                           <code>curl_setopt()</code>, where the key is a pre-defined <code>CURLOPT_*</code>
     *                           constant.</li> <li><code>returnCurlHandle</code> - <code>boolean</code> - Optional -
     *                           A private toggle specifying that the cURL handle be returned rather than actually
     *                           completing the request. This toggle is useful for manually managed batch
     *                           requests.</li></ul>                                                                                          
     ...
     * @param  array  $opt       (Optional) An associative array of parameters that can have the following keys: <ul>
     *                           <li><code>curlopts</code> - <code>array</code> - Optional - A set of values to pass
     *                           directly into <code>curl_setopt()</code>, where the key is a pre-defined
     *                           <code>CURLOPT_*</code> constant.</li> <li><code>returnCurlHandle</code> -
     *                           <code>boolean</code> - Optional - A private toggle specifying that the cURL handle
     *                           be returned rather than actually completing the request. This toggle is useful for
     *                           manually managed batch requests.</li></ul>                                                  
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
     ...
     * @param  array  $opt       (Optional) An associative array of parameters that can have the following keys: <ul>
     *                           <li><code>NextToken</code> - <code>string</code> - Optional - Token returned by the
     *                           previous ListSubscriptionsByTopic request. </li> <li><code>curlopts</code> -
     *                           <code>array</code> - Optional - A set of values to pass directly into
     *                           <code>curl_setopt()</code>, where the key is a pre-defined <code>CURLOPT_*</code>
     *                           constant.</li> <li><code>returnCurlHandle</code> - <code>boolean</code> - Optional -
     *                           A private toggle specifying that the cURL handle be returned rather than actually
     ...
     * @param  array  $opt       (Optional) An associative array of parameters that can have the following keys: <ul>
     *                           <li><code>Subject</code> - <code>string</code> - Optional - Optional parameter to be
     *                           used as the "Subject" line of when the message is delivered to e-mail endpoints.
     *                           This field will also be included, if present, in the standard JSON messages
     *                           delivered to other endpoints. Constraints: Subjects must be ASCII text that begins
     *                           with a letter, number or punctuation mark; must not include line breaks or control
     *                           characters; and must be less than 100 characters long. </li>
     *                           <li><code>curlopts</code> - <code>array</code> - Optional - A set of values to pass
     *                           directly into <code>curl_setopt()</code>, where the key is a pre-defined
     *                           <code>CURLOPT_*</code> constant.</li> <li><code>returnCurlHandle</code> -
     *                           <code>boolean</code> - Optional - A private toggle specifying that the cURL handle
