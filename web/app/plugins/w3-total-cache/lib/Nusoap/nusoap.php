...
class nusoap_client extends nusoap_base
{
    ...
    */
     ...
     *                            for the call.  For rpc style, this call will wrap
     *                            the XML in a tag named after the method, as well
     *                            as the SOAP Envelope and Body.  For document
     *                            style, this will only wrap with the Envelope and
     *                            Body. IMPORTANT: when using an array with document
     *                            style, in which case there is really one
     *                            parameter, the root of the fragment used in the
     *                            call, which encloses what programmers normally
     *                            think of parameters.  A parameter array *must*
     *                            include the wrapper.                              
     *
