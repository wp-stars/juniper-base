...
class WC_Customizations {
    ...
    public function product_technical_data_tab() {
        ...
        if(!!$product){
            $html .= '<div class="technical-data-tab-content">';
            ...
            if(!!($productMeta = $product->get_meta('_technical_data'))){
                $html .= wp_kses_post($productMeta);
            }
    ...
    public function product_description_tab() {
        ...
        $additionalText = get_field('wps_sp_additional_text', $productID) ?? '';
