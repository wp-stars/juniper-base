 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce-germanized-pro/single-product/food/nutri-score.php.
 *
...
<?php elseif ( $product->is_type( 'variable' ) ) : ?>
	<p class="wc-gzd-nutri-score wc-gzd-product-food-information wc-gzd-additional-info-placeholder"></p>
<?php endif; ?>
