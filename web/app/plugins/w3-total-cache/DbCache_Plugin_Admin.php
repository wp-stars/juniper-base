...
class DbCache_Plugin_Admin
{
    ...
    {
        // counters
        $dbcache_calls_total = Util_UsageStatistics::sum(
            $history,
            'dbcache_calls_total' 
        );
        $dbcache_calls_hits = Util_UsageStatistics::sum(
            $history,
            'dbcache_calls_hits' 
        );
        $dbcache_flushes = Util_UsageStatistics::sum(
            $history,
            'dbcache_flushes' 
        );
        $dbcache_time_ms = Util_UsageStatistics::sum(
            $history,
            'dbcache_time_ms' 
        );
