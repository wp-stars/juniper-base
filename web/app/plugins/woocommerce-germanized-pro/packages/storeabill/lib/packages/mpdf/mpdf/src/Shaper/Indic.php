...
namespace Vendidero\StoreaBill\Vendor\Mpdf\Shaper;
...
class Indic
{
	...
	public static function insert_dotted_circles(&$info, $dottedcircle)
	{
		...
		if (isset($info[$idx])) {
			throw new \Vendidero\StoreaBill\Vendor\Mpdf\MpdfException('Unexpected error occurred in Indic processing');
		}
