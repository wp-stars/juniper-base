jQuery(
    function ($) {
        ...
        $('body')
        .on(
            'click', '.w3tc_cdn_stackpath2_authorize', function () {
                W3tc_Lightbox.open(
                    {
                        id:'w3tc-overlay',
                        close: '',
        ...
        .on(
            'click', '.w3tc_cdn_stackpath2_list_stacks', function () {
        ...
        .on(
            'click', '.w3tc_cdn_stackpath2_list_sites', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_stackpath2_view_site', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_stackpath2_configure_site', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_stackpath2_configure_site_skip', function () {
                var url = ajaxurl + '?action=w3tc_ajax&_wpnonce=' + w3tc_nonce +
        ...
        .on(
            'click', '.w3tc_cdn_stackpath2_done', function () {
                // refresh page
