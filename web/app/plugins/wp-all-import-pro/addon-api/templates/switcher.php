<div class="pmxi-switcher">
    <div class="pmxi-switcher-radio-group">
        <label class="pmxi-switcher-radio-item">
            <input type="radio" id="<?php echo $switcher_id; ?>_yes" class="switcher" name="<?php echo $switcher_name; ?>" value="yes" <?php echo 'no' != $switcher_value ? 'checked="checked"' : '' ?> />
            <span><?php echo $yes_label; ?></span>
        </label>

        <label class="pmxi-switcher-radio-item">
            <input type="radio" id="<?php echo $switcher_id; ?>_no" class="switcher" name="<?php echo $switcher_name; ?>" value="no" <?php echo 'no' == $switcher_value ? 'checked="checked"' : ''; ?> />
