...
class Gallery extends Sortable
{
    ...
    {
        return new \MatthiasWeb\RealMediaLibrary\lite\folder\Gallery($rowData->id, $rowData->parent, $rowData->name, $rowData->slug, $rowData->absolute, $rowData->ord, $rowData->cnt_result, $rowData);
    }
    // Documented in IFolder
    ...
    {
        return parent::getTypeDescription($default === null ? \__('A gallery can only contain images. To view a gallery, go to a post and look at the buttons of the visual editor...', RML_TD) : $default);
    }
    // Documented in IFolder
