...
class UsageStatistics_Plugin_Admin
{
    function run()
    {
        ...
        add_action(
            'admin_init_w3tc_dashboard', array(
    ...
    public function w3tc_notes( $notes )
    {
        ...
        if ($c->get_boolean('stats.enabled') 
            ...
            $notes['stats_enabled'] = sprintf(
                __(
                    'W3 Total Cache: Statistics collection is currently enabled. This consumes additional resources, and is not recommended to be run continuously. %s %s',
                    'w3-total-cache' 
                ),
                Util_Ui::button_link(
